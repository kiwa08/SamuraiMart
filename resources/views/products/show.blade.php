 ...
 <div class="d-flex justify-content-center">
     <div class="row w-75">
         ...
         <div class="col">
             ...
             <form method="POST" action="{{route('carts.store')}}" class="m-3 align-items-end">
                 ...
                 <div class="row">
                     ...
                     <div class="col-5">
                        {{-- お気に入り登録・解除のリクエストを送信 --}}
                        {{-- route('products.favorite', $product)とすることで、商品情報をfavoriteアクションに渡す --}}
         ...
         <div class="offset-1 col-10">
             {{-- 全てのレビューが保存されている$reviewsからデータをとりだして表示 --}}
             <div class="row">
                @foreach($reviews as $review)
                    <div class="offset-md-5 col-md-5">
                        {{-- str_repeat関数＝指定した回数(評価の数)分くりかえした文字列を返す--}}
            ...
            {{-- @authログインしている状態でのみレビュー用のフォームが画面に表示 --}}
             @auth
             <div class="row">
                <div class="offset-md-5 col-md-5">
                    {{-- storeアクションで$requestから取得するcontentとproduct_idをviewのformから渡す --}}
